...
TEST_CASE("mitochondria", "[mitochondria]") {
    ...
    REQUIRE_THAT(floatTypes(diameters.begin(), diameters.end()),
                 Catch::Matchers::Approx(floatTypes{10.0, 20.0}));
    ...
    REQUIRE_THAT(res.at(0), Catch::Matchers::WithinAbs(0.5, 0.0001));
    REQUIRE_THAT(res.at(1), Catch::Matchers::WithinAbs(0.6, 0.0001));
    ...
    REQUIRE_THAT(floatTypes(neuriteSectionIds.begin(), neuriteSectionIds.end()),
                 Catch::Matchers::Approx(floatTypes{0.0, 0.0}));
    ...
    REQUIRE_THAT(floatTypes(neuriteSectionIds.begin(), neuriteSectionIds.end()),
                 Catch::Matchers::Approx(floatTypes{0.0, 1.0, 1.0, 2.0}));
